...
%global upstream_ver 26.2.5.9
%global package_ver  26.2.5.9
...
# A patch for a faulty ESXi 8.0.2 AVX-512 instruction set implementation
Patch3: otp-0004-esxi-8.0.2.patch
